// src/http/admin/screening-ckdsc/admin-get-screening-ckdsc-detail.ts

import { useQuery } from "@tanstack/react-query";
import { getScreeningCKDSCDetail } from "@/http/admin/screening-ckdsc/endpoint-screening-ckdsc-detail";
