// src/http/admin/screening-asbhd-avf/admin-get-screening-asbhd-avf-detail.ts

import { useQuery } from "@tanstack/react-query";
import { getScreeningASBHDAVFDetail } from "@/http/admin/screening-asbhd-avf/endpoint-screening-asbhd-avf-detail";
