// src/components/organisms/dashboard/medical/reports/pre-test/DashboardMedicalReportDetailPreTestWrapper.tsx
"use client";
...
interface DashboardMedicalReportDetailPreTestWrapperProps {
  id: string;
}

export default function DashboardMedicalReportDetailPreTestWrapper({
  id,
}: DashboardMedicalReportDetailPreTestWrapperProps) {
