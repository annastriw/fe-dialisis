// src/components/organisms/dashboard/medical/reports/screening/DashboardMedicalReportScreeningDetailWrapper.tsx
...
interface DashboardMedicalReportScreeningDetailWrapperProps {
  id: string;
}

export default function DashboardMedicalReportScreeningDetailWrapper({
  id,
}: DashboardMedicalReportScreeningDetailWrapperProps) {
