// src/components/organisms/dashboard/medical/reports/post-test/DashboardMedicalReportDetailPostTestWrapper.tsx
"use client";
...
interface DashboardMedicalReportDetailPostTestWrapperProps {
  id: string;
}

export default function DashboardMedicalReportDetailPostTestWrapper({
  id,
}: DashboardMedicalReportDetailPostTestWrapperProps) {
