...
import CardListReportHistoryPostTestMedical from "@/components/molecules/card/CardListReportHistoryPostTestMedical";
import CardListReportHistoryPreTestMedical from "@/components/molecules/card/CardListReportHistoryPreTestMedical";
import CardListReportHistoryScreeningMedical from "@/components/molecules/card/CardListReportHistoryScreeningMedical";
import CardASBHDAVFOverviewMedical from "@/components/molecules/card/CardASBHDAVFOverviewMedical";
import CardCKDSCOverviewMedical from "@/components/molecules/card/CardCKDSCOverviewMedical";
...
export default function DashboardMedicalReportWrapper() {
    ...
    <div>
      ...
      >
        ...
        <TabsContent value="screening">
          <CardListReportHistoryScreeningMedical
        ...
        <TabsContent value="pre-test">
          <CardListReportHistoryPreTestMedical
        ...
        <TabsContent value="post-test">
          <CardListReportHistoryPostTestMedical
        ...
        <TabsContent value="asbhd-avf">
          <CardASBHDAVFOverviewMedical />
        </TabsContent>

        <TabsContent value="ckdsc">
          <CardCKDSCOverviewMedical />
        </TabsContent>
      </Tabs>
    </div>
  );
