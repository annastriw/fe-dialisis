// src/components/organisms/dashboard/admin/reports/history/screening-asbhd-avf/DashboardAdminHistoryScreeningASBHDAVFDetailWrapper.tsx
...
interface DashboardAdminHistoryScreeningASBHDAVFDetailWrapperProps {
  id: string;
}

export default function DashboardAdminHistoryScreeningASBHDAVFDetailWrapper({
  id,
}: DashboardAdminHistoryScreeningASBHDAVFDetailWrapperProps) {
