// src/components/atoms/datacolumn/DataHistoryScreeningCKDSCMedical.tsx
"use client";
...
export const historyScreeningCKDSCColumns = (): ColumnDef<MedicalScreeningCKDSCHistoryItem>[] => [
  {
    accessorKey: "index",
    header: "No",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <ActionButton>
          <Link
            href={`/dashboard/medical/reports/history/screening-ckdsc/${data.history_id}`}
