// src/components/atoms/datacolumn/DataHistoryScreeningASBHDAVFAdmin.tsx
"use client";
...
interface HistoryScreeningASBHDAVFColumnProps {
  deleteHistoryScreeningHandler: (data: AdminScreeningASBHDAVFHistoryItem) => void;
}

export const historyScreeningASBHDAVFColumns = (
  props: HistoryScreeningASBHDAVFColumnProps,
): ColumnDef<AdminScreeningASBHDAVFHistoryItem>[] => [
  {
    accessorKey: "index",
    header: "No",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <ActionButton>
          <Link
            href={`/dashboard/admin/reports/history/screening-asbhd-avf/${data.history_id}`}
