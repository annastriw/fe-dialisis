...
export default function MessageDiscussion({ id }: MessageDiscussionProps) {
  ...
  return (
    <div className="mb-6 w-full">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="relative flex flex-col p-4 rounded-xl border bg-white gap-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-3 w-full">
            ...
            <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
              ...
              {form.watch("is_private") && (
                <FormField control={form.control} name="medical_id" render={({ field }) => (
            ...
            <div className="flex items-center gap-x-2 mt-2 md:mt-0 ml-auto">
              <button type="button" onClick={handleClickPaperclip} className="text-muted-foreground">
