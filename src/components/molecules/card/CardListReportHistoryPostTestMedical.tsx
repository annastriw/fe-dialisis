// src/components/molecules/card/CardListReportHistoryPostTestMedical.tsx
...
interface CardListReportHistoryPostTestMedicalProps {
  data: PostTest[];
  isLoading: boolean;
}

export default function CardListReportHistoryPostTestMedical({
  data,
  isLoading,
}: CardListReportHistoryPostTestMedicalProps) {
  if (isLoading) {
    return (
