// src/components/molecules/card/CardASBHDAVFOverviewMedical.tsx

import { Card, CardHeader, CardTitle } from "@/components/ui/card";
import { FileSearch } from "lucide-react";
import Link from "next/link";

export default function CardASBHDAVFOverviewMedical() {
  return (
    <Link
      href="/dashboard/medical/reports/history/screening-asbhd-avf"
          ...
          <CardHeader className="flex md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Tipe: Hemodialisis (Arteriovenous Fistula)
              </p>
            </div>
          </CardHeader>
        </Card>
