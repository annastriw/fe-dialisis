// src/components/molecules/card/CardListHistoryQuestionScreeningASBHDAVFMedical.tsx
"use client";
...
/* ---------- component ---------- */
export default function CardListHistoryQuestionScreeningASBHDAVFMedical({
  answers = [],
  score,
  interpretation,
  description,
